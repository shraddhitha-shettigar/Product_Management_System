...
<body>
    <div class="container">
        ...
        <form action="addProduct" method="post" onsubmit="return validateForm()">
            <div class="form-group">
                <label for="productId" class="required-field">Product ID</label>
                <div class="input-icon" data-icon="🆔">
                    <input type="number" id="productId" name="productId" required min="1" placeholder="Enter unique product ID"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon" data-icon="📦">
                    <input type="text" id="productName" name="productName" required maxlength="100" placeholder="Enter product name"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon" data-icon="🏷️">
                    <input type="text" id="category" name="category" required maxlength="50" placeholder="Enter product category"/>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon" data-icon="📊">
                        <input type="number" id="quantity" name="quantity" required min="0" placeholder="Stock quantity"/>
                    </div>
                </div>
            </div>
    ...
    <script>
        function validateForm() {
            ...
            if (pid <= 0) {
                showAlert("Product ID must be a positive number", "error");
                return false;
            }
            if (pname.length === 0) {
        ...
        function showAlert(message, type) {
            ...
            alertDiv.className = type === 'error' ? 'error' : 'message';
